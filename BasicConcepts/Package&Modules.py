# Packages / library: Simply a folder containing one or more modules. Contains a library or an executable or both.

# Modules: A set of python files, from which we can use the method of other packages.
